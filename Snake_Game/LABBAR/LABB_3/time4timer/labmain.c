...
{
  volatile short* timer_Status = (volatile short*)0x04000020;
  if(*timer_Status & 0b1)
  {
    *timer_Status &= !(1);
  }
...
{
  //volatile short* timer_Status = (volatile short*)0x04000020;
  volatile short* timer_Control = (volatile short*)0x04000024;

  *timer_Control |= 0b1; 

  volatile short* timer_periodl = (volatile short*)0x04000028;
  *timer_periodl |= 0xfff; 
  *(timer_periodl+4) |= 0xfff; 
  *timer_Control |= (0b1 << 2);

  asm volatile("csrrsi, mie, 16");
  asm volatile("csrrsi mstatus, 3");
